...
public class LoginPanel extends JPanel
{
	...
	Dimension LOGIN_BUTTON_DIMENSIONS = new Dimension(330, 50);
	
	private static final
	Insets TEXT_FIELD_INSET = new Insets(0, 5, 0, 5);
	
	private static final
	Border PANEL_MARGIN = BorderFactory.createLineBorder(new Color(0, 0, 0, 0), 30, true),
		   PANEL_BORDER = BorderFactory.createLineBorder(new Color(245, 189, 2, 255), 8, false);
	
	private static final
	Font LABEL_FONT = new Font("Sans Serif",Font.BOLD, 16),
		 LOGIN_BUTTON_FONT = new Font("Sans Serif", Font.BOLD, 25);
	
	private static final
	Color LOGIN_BUTTON_COLOR = new Color(206, 32, 41),
		  BACKGROUND_COLOR = new Color(0, 0, 0, 192),
		  LABEL_FONT_COLOR = Color.WHITE;
	
	private static final
	String MILITARY_FONT_DIR = "res/Client/Fonts/Military Stencil.ttf",
		   BACKGROUND_IMG_DIR = "res/Client/Images/LoginBackground.jpg";
	
	private static final
	int FIELD_SPACING = 30,
		SPECIAL_SPACING = 70;
	...
	JLabel titleLabel = new JLabel("BATTLESHIP"),
		   ...
		   serverAddressLabel = new JLabel("Address:"),
		   serverPortLabel = new JLabel("Port:");
	
	private final
	JLabel[] allLabels = { usernameLabel,
						   serverAddressLabel,
						   serverPortLabel };
	
	private
	JTextField username = new JTextField("Player"),
			   serverAddress = new JTextField("127.0.0.1"),
			   serverPort = new JTextField("9992");
	
	private final
	JTextField[] allTextFields = { username,
								   serverAddress,
								   serverPort };
	
	private
	JButton loginButton = new JButton("LAUNCH");
