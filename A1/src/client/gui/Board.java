...
public class Board extends JPanel
{
	...
	private static final
	Color LABEL_COLOR = new Color(48,54,66);
	
	private static final
	Dimension PANEL_DIMENSIONS = new Dimension(PANEL_SIZE, PANEL_SIZE),
	...
	private
	JLabel[] xLabels = new JLabel[GRID_SIZE],
			 yLabels = new JLabel[GRID_SIZE];
