...
public class MainWindow
{
	...
	private static final
	Color OUTPUT_BG_COLOR = new Color(1, 36, 86),
		  START_BG_COLOR = new Color(218, 255, 209);
	
	private static final
	Insets TEXT_AREA_MARGIN = new Insets(10, 5, 5, 5);
	
	private static final
	Font OUTPUT_FONT = new Font("DejaVu Sans Mono", Font.PLAIN, 15);
	
	private static final
	Border TIMER_BORDER = BorderFactory.createEmptyBorder(0, 15, 0, 15),
		   START_BORDER = BorderFactory.createStrokeBorder(new BasicStroke(2), new Color(32, 210, 0));
	
	private static final
	Dimension START_BUTTON_DIMENSION = new Dimension(0, START_BUTTON_HEIGHT),
	...
	/**
	 * Sets the text for the Start/Stop button depending on whether the server is running or not
	 */
