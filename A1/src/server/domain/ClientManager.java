...
{	
	 ...
	 * Creates a ConnectionManager and sets itself as an Observer
	 */
	 ...
	 * Gets a new Client from the ConnectionManager and adds it to clients
	 */
	@Override
	public void update()
	{
	...
	/**
	 * Looks for 2 players ready for a match
	 * NOT COMPLETE
	 */
