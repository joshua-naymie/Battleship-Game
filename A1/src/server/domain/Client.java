...
public class Client extends Subject<ByteBuffer>
{
	...
	String SOCKET_CLOSED_ERROR = "ERROR: socket is closed!",
	 ...
	 * While the client is connected, waits for input from the client socket and responds
	 */
	@Override
	public void run()
	{
	...
	/**
	 * Tries to read the length of the incoming message
	 ...
	 * @return the incoming message. returns NC.ERROR code if an error is encountered
	 */
